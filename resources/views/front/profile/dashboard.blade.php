    ...
    <div class="container">
        <div class="col-xl-12 col-lg-12 col-md-10 d-flex flex-column dash-index">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 my-4 dash-index-info">
                ...
                <div class="row mx-1 my-3">
                    <div class="col-lg-6"> نام خانوادگی : {{ $user->last_name == null ? 'ثبت نشده' : $user->last_name }}</div>
                    <div class="col-lg-6"> نام : {{ $user->first_name  == null ? 'ثبت نشده' : $user->first_name }}</div>
                </div>
                <div class="row mx-1 my-3">
                    <div class="col-lg-6"> موبایل : {{ $user->mobile  == null ? 'ثبت نشده' : $user->mobile }} </div>
                </div>
            </div>
        </div>
    </div>
