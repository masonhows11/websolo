                    ...
                    <div class="col-md-6  h-75">
                        <div class="wk-post-section my-3">
                             ...
                             <div class="wk-post-img">
                                 <img src="{{ asset('/storage/images/'.$article->image) }}" class="rounded-4" alt="post-image">
                             </div>
                                    ...
                                    <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col">
                                        <div class="d-flex flex-start mb-4">
                                            <img class="rounded-circle shadow-1-strong me-3"
                                                 src="{{ $comment->user->image_path  ? asset('images/users/' . $comment->user->image_path): asset('images/users/no-user.png') }}"
                                                 alt="avatar"/>
