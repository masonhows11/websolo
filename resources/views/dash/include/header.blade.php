                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                            ...
                            <img src="{{ asset('assets/dash/images/no-user.png') }}" alt="metronic"/>
                        </div>
                        <div
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo" src="{{ asset('assets/dash/images/no-user.png') }}"/>
                                    </div>
                            ...
                            <div class="menu-item px-5">
                                <a href="{{ route('admin.adminProfile') }}" class="menu-link px-5">پروفایل من</a>
                            </div>
                            <div class="menu-item px-5">
                                <a href="#" class="menu-link px-5">
                                    <span class="menu-text">پروژه ها من</span>
                                    <span class="menu-badge"><span class="badge badge-light-danger badge-circle fw-bolder fs-7">3</span></span>
                                </a>
                            </div>
                            ...
                            <div class="menu-item px-5">
                                <a href="{{ route('admin.adminLogOut') }}" class="menu-link px-5">خروج</a>
                            </div>
