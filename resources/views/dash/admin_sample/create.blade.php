...
@section('dash_main_content')
    <div class="container-fluid">
        ...
        <div class="sample-section-create">
            ...
            <form action="{{ route('admin.sampleStore') }}" method="post">
                @csrf
                    ...
                    <div class="col">
                        ...
                        <div class="my-5">
                            <label for="front-end" class="form-label">زبان یا فریم ورک سمت کاربر
                                (front-end)</label>
                            <select type="text" multiple class="form-contro chosen-select" id="front-end"
                                    name="front_ends[]">
                ...
                <div class="row">
                    <div class="col-lg-10">
                        <div class="form-group my-5">
                            <label for="editor-text" class="form-label">خلاصه</label>
