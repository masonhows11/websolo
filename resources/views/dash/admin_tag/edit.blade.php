    ...
    <div class="container-fluid">
        ...
        <div class="row d-flex justify-content-center tag-section-create">
            <div class="col-lg-4 col-md-5  col-sm-5 col-xs-5  category-create">
                <form action="{{ route('admin.tagUpdate') }}" method="post">
                    @csrf
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" name="title_persian" class="form-control @error('title_persian') is-invalid @enderror"
                               id="title_persian" value="{{ $tag->title_persian }}">
                    </div>
                    @error('title_persian')
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" name="title_english" dir="ltr"
                               ...
                               id="title_english" value="{{ $tag->title_english }}">
                    </div>
                    @error('title_english')
                    <div class="alert alert-danger">{{ $message}}</div>
                    @enderror
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <a href="{{ route('admin.tagIndex') }}" class="btn btn-secondary">انصراف</a>
                    </div>
                </form>
            </div>
        </div>
